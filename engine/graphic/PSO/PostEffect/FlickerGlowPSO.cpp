...
void FlickerGlowPSO::Initialize()
{
    PostEffectPSOBase::Initialize();
    CreateGraphicPipeline();
}

void FlickerGlowPSO::CreateGraphicPipeline()
{
    PostEffectPSOBase::CreateGraphicPipeline(
        L"Resources/Shaders/PostEffect/CopyImage.VS.hlsl", 
        L"Resources/Shaders/PostEffect/FlickerGlow.PS.hlsl");
	     
}

void FlickerGlowPSO::CreateRootSignature()
{
