...
void DepthBasedOutlinePSO::Initialize() {
    PostEffectPSOBase::Initialize();
    CreateGraphicPipeline();
}

void DepthBasedOutlinePSO::CreateGraphicPipeline() {
	// ルートシグネチャ作成
	CreateRootSignature();
	...
	PostEffectPSOBase::CreateGraphicPipeline(
        ...
        L"Resources/Shaders/PostEffect/DepthBasedOutline.PS.hlsl"
    );
}

void DepthBasedOutlinePSO::CreateRootSignature() {
